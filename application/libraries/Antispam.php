...
class Antispam {
	...
	*/
	...
	var $img_path 		=   './assets/homefiles/pics/captcha_images/'; // Image path
	var $img_width 		= 	120;   	// CODE_WIDTH
	var $img_height 	= 	30;		// CODE_HEIGHT	

	var $font_name		= 	FALSE;		// test.ttf
	var $font_path 		= 	'./assets/homefiles/fonts';  // PATH_TTF	
	...
	function get_antispam_image( $override = array() ) {
        ...
        $this->_CI->load->module('Capcha');
	
	
        $this->_CI->capcha->InsertCapchaToDB($img_name);
